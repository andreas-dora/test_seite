function init(){
    ...
    const startStr = document.getElementById('id_startStr');
    
    const startCitySelect = document.getElementById('id_startCity');
    ...
    function citySelect(){
        console.log('citySelect: ' + startCitySelect.value);
